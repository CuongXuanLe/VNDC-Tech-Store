      ...
      <h1 class="text-start font-rubik py-2 text-capitalize">new release</h1>
         <div class="row slider">
            <div class="col-md-12 text-center">
               <div class="item">
                  <img src="./images/ip1.jpg" class="d-block w-100 rounded" alt="banner_1">
               </div>  
            </div>
            <div class="col-md-12 text-center">
               <div class="item">
                  <img src="./images/ip2.jpg" class="d-block w-100 rounded" alt="banner_1">
               </div>  
            </div>
            <div class="col-md-12 text-center">
               <div class="item">
                  <img src="./images/ip6.jpg" class="d-block w-100 rounded" alt="banner_1">
               </div>  
            </div>
            <div class="col-md-12 text-center">
               <div class="item">
                  <img src="./images/ip5.jpg" class="d-block w-100 rounded" alt="banner_1">
               </div>  
            </div>
            <div class="col-md-12 text-center">
               <div class="item">
                  <img src="./images/ip4.jpg" class="d-block w-100 rounded" alt="banner_1">
               </div>  
            </div>
            <div class="col-md-12 text-center">
               <div class="item">
                  <img src="./images/ip3.jpg" class="d-block w-100 rounded" alt="banner_1">
               </div>  
            </div>
         </div>
      </div>
