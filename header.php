...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow">
   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
         ...
         <!-- Left links -->
         <ul class="navbar-nav pl-5 mb-2 mb-md-0 m-auto">
            <li class="nav-item my-auto">
               <a class="nav-link pr-5 text-decoration-none text-dark font-rubik text-capitalize" style="font-size:1.4rem" href="about.php">About</a>
            </li>
            <li class="nav-item my-auto">
               <a class="nav-link pr-5 text-decoration-none text-dark font-rubik text-capitalize" style="font-size:1.6rem" href="shop.php">shop</a>
            </li>
            <li class="nav-item my-auto active">
               <a class="nav-link pr-5 text-decoration-none text-dark font-rubik text-capitalize" style="font-size:1.8rem"  href="home.php" >Home</a>
            </li>
            <li class="nav-item my-auto">
               <a class="nav-link pr-5 text-decoration-none text-dark font-rubik text-capitalize" style="font-size:1.6rem" href="orders.php">order</a>
            </li>
            <li class="nav-item my-auto">
               <a class="nav-link pr-5 text-decoration-none text-dark font-rubik text-capitalize" style="font-size:1.4rem" href="contact.php">connect us</a>
            </li>
         </ul>
      </div>
      ...
      <div class="d-flex align-items-center">
            <a href="search_page.php" class="mr-3 text-success text-decoration-none px-1 btn btn-light border border-success">Search</a>
            <?php
            ...
            <!-- toggle menu use -->
            <div class="dropdown">
               <div class="fas fa-user mx-3 px-1" data-toggle="dropdown"></div>
